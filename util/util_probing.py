...
def save_zero_dist_csv(zd_dict, configdict, layer_idx):
    seed = configdict['seed']
    split_str = f'sd{seed}_train'
    layer_str = f'l{layer_idx}'
...
def save_twonn_ids(twonn_arr, configdict, layer_idx, class_idx):
    seed = configdict['seed']
    split_str = f'sd{seed}_train'
    layer_str = f'l{layer_idx}'
    other_str = None
...
def save_twonn_sizes(twonn_arr, configdict, layer_idx, class_idx):
    seed = configdict['seed']
    split_str = f'sd{seed}_train'
    layer_str = f'l{layer_idx}'
    other_str = None
...
def load_biased_part_rto(configdict, layer_idx, class_idx):
    seed = configdict['seed']
    split_str = f'sd{seed}_train'
    layer_str = f'l{layer_idx}'
    other_str = None
