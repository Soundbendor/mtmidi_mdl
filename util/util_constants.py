...
TWONN_PC_FOLDER = 'twonn-pc'
TWONN_PC_SIZE_FOLDER = 'twonn-pc_sz'
...
BIASED_PART_RTO_PC_FOLDER = 'b_pr-pc'
UNBIASED_PART_RTO_PC_FOLDER = 'ub_pr-pc'
BIASED_PART_RTO_PC_NONSTANDARD_FOLDER = 'b_pr-pc-nstd'
UNBIASED_PART_RTO_PC_NONSTANDARD_FOLDER = 'ub_pr-pc-nstd'

EFFECTIVE_DIM_N1_FOLDER = 'ed_n1'
EFFECTIVE_DIM_N1_NONSTANDARD_FOLDER = 'ed_n1-nstd'
EFFECTIVE_DIM_N1_PC_FOLDER = 'ed_n1-pc'
